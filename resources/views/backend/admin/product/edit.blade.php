                            ...
                            <form action="{{ url('admin/product-update/' . $product->id) }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" name="color[]" value="orange"
                                        {{ in_array('orange', $selectedColors) ? 'checked' : '' }}>
                                    @error('color')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" name="size[]" value="xs"
                                        {{ in_array('xs', $selectedSizes) ? 'checked' : '' }}>
                                    <label for="S">S</label>
                                    ...
                                    <select name="catagory_id" class="form-control" required>
                                        ...
                                        @foreach ($catagories as $catagory)
                                            <option value="{{ $catagory->id }}"
                                                {{ $product->catagory_id == $catagory->id ? 'selected' : '' }}>
                                                {{ $catagory->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-4">
                                    ...
                                    <select class="form-select" id="state" name="state">
                                        <option value="latest" {{ $product->state === 'latest' ? 'selected' : '' }}>
                                            Latest</option>
                                        <option value="top_rated"
                                            {{ $product->state === 'top_rated' ? 'selected' : '' }}>Top Rated</option>
                                        <option value="featured"
                                            {{ $product->state === 'featured' ? 'selected' : '' }}>Featured</option>
                                        <option value="review" {{ $product->state === 'review' ? 'selected' : '' }}>
                                            Review</option>
                                    </select>
                                </div>
                                <div class="form-group">
